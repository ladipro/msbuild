    ...
    public class ProjectChooseElement : ProjectElementContainer
    {
        ...
        internal override void VerifyThrowInvalidOperationAcceptableLocation(ProjectElementContainer parent, ProjectElement previousSibling, ProjectElement nextSibling)
        {
            ...
            while (parent != null)
            {
                ...
                ProjectErrorUtilities.VerifyThrowInvalidProject(nestingDepth <= ProjectParser.MaximumChooseNesting, immediateParent.InternalLocation, "ChooseOverflow", ProjectParser.MaximumChooseNesting);
            }
        }
